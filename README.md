...
In the folder **performance_analyses**, there is 1 file: `code_performance_analysis.R`: code for running the performance analysis over the statistical results obtained from the statistical models.

In the folder **plot_results**, there is 1 file: `code_plot_results.Rmd`: code for generating the plot of the results of each scenario.
